Param(
    [Switch]$DoItFast,
    $MaxThreads = 5,
    $FilePath = "C:\temp\PingResultRunspacePool.txt"
    )
...
If ($DoItFast){
    ...
    $Servers | Foreach-Object {
        ...
        #consume more resources on the host running the script. Playing with 
        #maximum threads parameter can show where the sweet-spot is for the number
        #of threads, there will be a spot where we get no more reduction in time to
